...
myRBM.set_autostop(window=100, stride=40)
myRBM.train(x_train, x_valid, k=5, epoch=3000, learning_rate=0.01, batch_size=32, plotfile='script-2-2-k=5')

myRBM = rbm.RBM(28*28, hidden_units=100)
myRBM.set_visualize(28, 28, stride=20)
myRBM.set_plot(stride=20)
myRBM.set_autostop(window=100, stride=40)
myRBM.train(x_train, x_valid, k=10, epoch=3000, learning_rate=0.01, batch_size=32, plotfile='script-2-2-k=10')

myRBM = rbm.RBM(28*28, hidden_units=100)
myRBM.set_visualize(28, 28, stride=20)
myRBM.set_plot(stride=20)
myRBM.set_autostop(window=100, stride=40)
myRBM.train(x_train, x_valid, k=20, epoch=3000, learning_rate=0.01, batch_size=32, plotfile='script-2-2-k=20')