...
train_settings = uf.TrainSettings(learning_rate=0.1, batch_size=16, momentum=0.0, plot_callback=cb.plot_callback,
                                  loss_callback=cb.loss_callback, filename='script-3-7', epoch=100, prefix='h128')
